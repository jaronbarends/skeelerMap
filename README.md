...
I may very well be the only one using this app, but I wanted to have the option for other skaters to use it too, so I added the possiblity to create accounts. Registered users can create, edit, and delete their own segments and markers.

## Tech stack

|                                    |                                                                                                                                                                                   |
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Next.js 15 (App Router)            | Framework — chosen deliberately learning purposes, rather than reach for a simpler SPA setup                                                                                      |
| TypeScript                         |                                                                                                                                                                                   |
